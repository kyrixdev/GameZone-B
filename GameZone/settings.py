...
SECRET_KEY = 'django-insecure-%1bv7#xob^q#cds61luypm53k5m=tjrekyhq=wmpsb)t+*%^%$'
...
JAZZMIN_SETTINGS = {
    ...
    "site_logo": "assets/logo/logo_white.png",
    ...
    "welcome_sign": "Welcome to GameZone",

    # Copyright on the footer
    "copyright": "Gameszone.tn",
